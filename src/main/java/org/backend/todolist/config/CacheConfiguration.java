package org.backend.todolist.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("BACKEND_TODOLIST");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("BACKEND_TODOLIST");
        ...
        config.getMapConfigs().put("org.backend.todolist.domain.*", initializeDomainMapConfig(jHipsterProperties));
